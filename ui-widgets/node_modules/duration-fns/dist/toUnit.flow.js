/**
 * Flowtype definitions for toUnit
 ...
 */
declare export var toMilliseconds: (duration: DurationInput) => number;
/**
 * Convert the input value to the specificed unit.
 * @example toUnit({ minutes: 2 }, 'seconds') // 120
 */
declare export var toUnit: (
  duration: DurationInput,
  unit: $Keys<typeof UNITS_META_MAP>
) => number;
/**
 * Convert the input value to seconds.
 * @example toSeconds({ minutes: 2 }) // 120
 */
declare export var toSeconds: (duration: DurationInput) => number;
/**
 * Convert the input value to minutes.
 * @example toMinutes({ hours: 1, minutes: 10 }) // 70
 */
declare export var toMinutes: (duration: DurationInput) => number;
/**
 * Convert the input value to hours.
 * @example toHours({ days: 1 }) // 24
 */
declare export var toHours: (duration: DurationInput) => number;
/**
 * Convert the input value to days.
 * @example toDays({ hours: 12 }) // 0.5
 */
declare export var toDays: (duration: DurationInput) => number;
/**
 * Convert the input value to weeks.
 * @example toWeeks({ days: 14 }) // 2
 */
declare export var toWeeks: (duration: DurationInput) => number;
/**
 ...
 */
declare export var toMonths: (duration: DurationInput) => number;
/**
 ...
 */
declare export var toYears: (duration: DurationInput) => number;
